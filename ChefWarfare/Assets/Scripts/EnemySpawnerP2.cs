...
public class EnemySpawnerP2 : MonoBehaviour
{
    ...
    void Update()
    {
        if (playerMovementScript.isMac == false)
        {
            ...
            {
                //axis for dpad Up/Down
                dpadVertical = Input.GetAxisRaw("PS4_Button_DPAD_Vertical_P2");
                dpadHorizontal = Input.GetAxisRaw("PS4_Button_DPAD_Horizontal_P2");
            }
        ...
        else if (playerMovementScript.isMac == true)
        {
            ...
            {
                //axis for dpad Up/Down
                dpadVertical = Input.GetAxisRaw("PS4_Button_DPAD_Vertical_P2_MAC");
                dpadHorizontal = Input.GetAxisRaw("PS4_Button_DPAD_Horizontal_P2");
            }
        ...
        if (inMyZone == true)
        {
            ...
            else if (playerMovementScript.isMac == true && levelLogicScript.gameIsPaused == false)
            {
                ...
                /*else if (SceneSwitchingScript.isXbox == false)
                {
                    if (enemySpawnerActive == false && Input.GetButtonDown("PS4_Button_DPAD_VerticalUp_P2_MAC"))
                    {
                        enemySpawnerActive = true;
                    }
                    //click dpad-down, deactivates spawner
                    else if (enemySpawnerActive == true && Input.GetButtonDown("PS4_Button_DPAD_VerticalDown_P2_MAC"))
                    {
                        enemySpawnerActive = false;
                    }
                }*/
                ...
                {
                    //if hit right dpad
                    if (Input.GetButtonDown("PS4_Button_DPAD_HorizontalRight_P2_MAC") && switchEnemyTypeTimer < 0)
                    {
                        switchEnemyTypeTimer = .5f;
                        theEnemyType += 1;
                        //loops enum back to Bread(1) if player pushes too much to the right
                    ...
                    //if hit left dpad
                    else if (Input.GetButtonDown("PS4_Button_DPAD_HorizontalLeft_P2_MAC") && switchEnemyTypeTimer < 0)
                    {
                        switchEnemyTypeTimer = .5f;
                        theEnemyType -= 1;
                        //loops enum to Cheese(5) if player pushes too much to the left
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (LevelLogic.mode == "2v2" && other.gameObject.name == "Player4")
        {
            GameObject.Find("EnemySpawnerP4").GetComponent<EnemySpawnerP4>().enemySpawner_UI.SetActive(true);
            GameObject.Find("EnemySpawnerP4").GetComponent<EnemySpawnerP4>().resources_UI.SetActive(true);
        }
    ...
    void OnTriggerExit2D(Collider2D other)
    {
        ...
        if (LevelLogic.mode == "2v2" && other.gameObject.name == "Player4")
        {
            GameObject.Find("EnemySpawnerP4").GetComponent<EnemySpawnerP4>().enemySpawner_UI.SetActive(false);
            GameObject.Find("EnemySpawnerP4").GetComponent<EnemySpawnerP4>().resources_UI.SetActive(false);
        }
